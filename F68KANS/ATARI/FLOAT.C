 ...
 * history
 */
/* JPS950117: to_float changed. Returns a flag now  */
...
long cdecl to_float(char *nstr, long len)
{ 
char str[256];
double x;
	...
	if( (x == 0.0 && qnull(str) == 0)) return 0L;
...
/* determine wether a string describes the number 0.0 */
int qnull( char *s )
{
int l;
int i=0;
