...
/*	_difftime,	*/
  ...
  _strcmp, _strncmp, _stricmp, _strnicmp, _strstr, 
...
long cdecl _strcmp( char* s1, long l1, char* s2 , long l2)
{
char st1[256];
char st2[256];

	memcpy( st1, s1, (size_t)l1 );
	st1[l1] = '\0'; 
	memcpy( st2, s2, (size_t)l2 );
	st2[l2] = '\0'; 

	return (long)strcmp( st1, st2 );
}


long cdecl _strncmp( char* s1, long l1, char* s2 , long l2, long len )
{
char st1[256];
char st2[256];
	...
	return (long)strncmp( st1, st2, len );
}



long cdecl _stricmp( char* s1, long l1, char* s2 , long l2)
{
char st1[256];
char st2[256];
	...
	return (long)stricmp( st1, st2 );
}



long cdecl _strnicmp( char* s1, long l1, char* s2 , long l2, long len )
{
char st1[256];
char st2[256];
	...
	return (long)strnicmp( st1, st2, len );
}


long cdecl _strstr( char* s1, long l1, char* s2 , long l2)
{
char st1[256];
char st2[256];
char *pos;
